...
BUILDPACK_ORDER := multi ruby nodejs gcf-nodejs clojure python java gradle grails scala play php go erlang static
SHELL := /bin/bash
...
release: build
	...
	gh-release create caffeinatedexpert/$(NAME) $(VERSION) \
